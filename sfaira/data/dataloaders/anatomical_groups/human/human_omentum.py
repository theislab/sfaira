...
class DatasetGroupOmentum(DatasetGroup):
    ...
    def __init__(
        ...
        dsg.subset(key="id", values=[
            "human_omentum_2020_microwell_han_001_10.1038/s41586-020-2157-4",
            "human_omentum_2020_microwell_han_002_10.1038/s41586-020-2157-4",
            "human_omentum_2020_microwell_han_003_10.1038/s41586-020-2157-4"
        ])
