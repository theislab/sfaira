...
class DatasetGroupMuscle(DatasetGroup):
    ...
    def __init__(
        ...
        dsg.subset(key="id", values=[
            "mouse_muscle_2019_10x_pisco_001_10.1101/661728",
            "mouse_muscle_2019_smartseq2_pisco_001_10.1101/661728",
            "mouse_muscle_2018_microwell-seq_han_001_10.1016/j.cell.2018.02.001",
        ])
