...
class Dataset(Dataset_d10_1016_j_cell_2018_02_001):
    ...
    def __init__(
        ...
        self.id = "mouse_mammarygland_2018_microwell-seq_han_003_10.1016/j.cell.2018.02.001"
        self.download = "https://ndownloader.figshare.com/articles/5435866?private_link=865e694ad06d5857db4b"
        self.organ = "mammary gland"
    ...
    def _load(self, fn=None):
        if fn is None:
            ...
            fn = os.path.join(self.path, "mouse", "temp_mouse_atlas/500more_dge", "MammaryGland.Virgin3_dge.txt.gz")
