...
class Dataset(DatasetBase):
    ...
    def _load(self, fn=None):
        if fn is None:
            fn = [
                os.path.join(self.path, "loaders", "lung", "GSE135893_matrix.mtx.gz"),
                os.path.join(self.path, "loaders", "lung", "GSE135893_genes.tsv.gz"),
                os.path.join(self.path, "loaders", "lung", "GSE135893_barcodes.tsv.gz"),
                os.path.join(self.path, "loaders", "lung", "GSE135893_IPF_metadata.csv.gz"),
            ]
