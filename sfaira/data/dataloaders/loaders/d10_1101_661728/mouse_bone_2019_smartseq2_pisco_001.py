...
class Dataset(Dataset_d10_1101_661728):
    ...
    def __init__(
        ...
        self.id = "mouse_bone_2019_smartseq2_pisco_001_10.1101/661728"
        self.organ = "bone"
    ...
    def _load(self, fn=None):
        if fn is None:
            ...
            if self.source == "aws":
                fn = os.path.join(self.path, "mouse", "bone", "tabula-muris-senis-facs-processed-official-annotations-Marrow.h5ad")
            elif self.source == "figshare":
                fn = os.path.join(self.path, "mouse", "bone", "Marrow_facs.h5ad")
            else:
