...
def load(data_dir, **kwargs):
    ...
    assay_diff_dict = {
        ...
        "ChP2": "Lancaster, 2014 (doi: 10.1038/nprot.2014.158); Lancaster, 2017 (doi: 10.1038/nbt.3906); added CHIR and BMP4 for ChP patterning on day 10 (Pellegrini, 2020 (doi: 10.1126/science.aaz5626))",
