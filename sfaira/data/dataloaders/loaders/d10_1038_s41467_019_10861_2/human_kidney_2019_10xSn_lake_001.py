...
class Dataset(DatasetBase):
    ...
    def _load(self, fn=None):
        if fn is None:
            fn = [
                os.path.join(self.path, "loaders", "kidney", "GSE121862_UCSD-WU_Single_Nuclei_Cluster_Annotated_Raw_UMI_Matrix.tsv.gz"),
                os.path.join(self.path, "loaders", "kidney", "GSE121862_UCSD-WU_Single_Nuclei_Cluster_Annotations.csv.gz")
            ]
