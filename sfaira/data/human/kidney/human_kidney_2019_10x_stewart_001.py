...
class Dataset(DatasetBase):
    ...
    def _load(self, fn=None):
        ...
        self.adata.uns[ADATA_IDS_SFAIRA.author] = 'Clatworthy'
        self.adata.uns[ADATA_IDS_SFAIRA.year] = 2019
        self.adata.uns[ADATA_IDS_SFAIRA.doi] = '10.1126/science.aat5031'
        ...
        self._convert_and_set_var_names(symbol_col='index', ensembl_col='ID', new_index=ADATA_IDS_SFAIRA.gene_id_ensembl)
