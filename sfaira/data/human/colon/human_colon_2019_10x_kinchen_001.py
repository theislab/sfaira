...
class Dataset(DatasetBase):
    ...
    def _load(self, fn=None):
        ...
        self.adata.uns[ADATA_IDS.author] = 'Simmons'
        self.adata.uns[ADATA_IDS.year] = 2019
        self.adata.uns[ADATA_IDS.doi] = "10.1016/j.cell.2018.08.067"
        ...
        self.adata.obs[ADATA_IDS.healthy] = [line == 'normal' for line in
                                     self.adata.obs['donor_organism.diseases.ontology_label']]
        self.adata.obs[ADATA_IDS.state_exact] = self.adata.obs['donor_organism.diseases.ontology_label'].astype('category')
