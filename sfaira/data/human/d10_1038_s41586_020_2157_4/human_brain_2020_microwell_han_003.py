...
class Dataset(DatasetHcl):
    ...
    def __init__(
        ...
        super().__init__(self=self, path=path, meta_path=meta_path, **kwargs)        self.id = "human_brain_2020_microwell_han_003_10.1038/s41586-020-2157-4"
        self.organ = 'brain'
    ...
    def _load(self, fn=None):
        self._load_hcl(fn=fn, sample_id="FetalBrain_3")
