...
class Dataset(DatasetHcl):
    ...
    def __init__(
        ...
        super().__init__(self=self, path=path, meta_path=meta_path, **kwargs)        self.id = "human_pancreas_2020_microwell_han_001_10.1038/s41586-020-2157-4"
        self.organ = 'Pancreas'
        self.sub_tissue = 'AdultPancreas'
    ...
    def _load(self, fn=None):
        self._load_hcl(fn=fn, sample_id="AdultPancreas_1")
