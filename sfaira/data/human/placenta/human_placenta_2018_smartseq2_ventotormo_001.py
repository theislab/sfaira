...
class Dataset(DatasetBase):
    ...
    def __init__(
        ...
        self.download_website = 'https://www.ebi.ac.uk/arrayexpress/files/E-MTAB-6678/E-MTAB-6678.processed.1.zip'
        self.download_website_meta = 'https://www.ebi.ac.uk/arrayexpress/files/E-MTAB-6678/E-MTAB-6678.processed.2.zip'
        self.organ = "placenta"
    ...
    def _load(self, fn=None):
        ...
        self.adata.uns[ADATA_IDS_SFAIRA.doi] = '10.1038/s41586-018-0698-6'
        ...
        self.adata.obs[ADATA_IDS_SFAIRA.cell_ontology_class] = self.adata.obs['annotation']
