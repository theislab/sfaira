...
class Dataset(DatasetBase):
    ...
    def __init__(
        ...
        self.species = "human"
        self.id = "human_lung_2020_microwell_han_005_10.1038/s41586-020-2157-4"
        self.organ = 'lung'
        ...
        self.class_maps = {
            "0": {
                'AT2 cell': 'AT2',
                'Antigen presenting cell (RPS high)': '1_Unicorns and artifacts',
                'B cell': 'B cell lineage',
                'B cell (Plasmocyte)': 'B cell lineage',
                'Basal cell': 'Basal',
                'CB CD34+': '2_Fetal airway progenitors',
                ...
                'Fasciculata cell': '1_Unicorns and artifacts',
                'Fetal Neuron': '1_Unicorns and artifacts',
                'Fetal chondrocyte': '1_Stroma',
                'Fetal endocrine cell': '1_Unicorns and artifacts',
                ...
                'Fetal neuron': '1_Unicorns and artifacts',
                'Fetal skeletal muscle cell': '1_Unicorns and artifacts',
                'Fetal stromal cell': '1_Stroma',
                'Fibroblast': 'Fibroblasts',
                'Gastric endocrine cell': '1_Unicorns and artifacts',
                'Goblet cell': 'Secretory',
                'Kidney intercalated cell': '1_Unicorns and artifacts',
                'Loop of Henle': '1_Unicorns and artifacts',
                ...
                'Primordial germ cell': '1_Unicorns and artifacts',
                'Proliferating T cell': 'T cell lineage',
                'Proximal tubule progenitor': '1_Unicorns and artifacts',
                ...
                'hESC': '2_Fetal airway progenitors',
            },
        }
    ...
    def _load(self, fn=None):
        ...
        if self._load_raw or not self._load_raw:
            if fn is None:
                fn = os.path.join(self.path, "human/lung/hcl_FetalLung_2.h5ad")
