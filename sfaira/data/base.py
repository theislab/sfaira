...
class DatasetBase(abc.ABC):
    ...
    def download(self, **kwargs):
        ...
        assert self._data_path is not None, "No path was provided when instantiating the dataset container, " \
    ...
    def _download_synapse(self, synapse_entity, fn, **kwargs):
        ...
        shutil.move(dataset._data_path, os.path.join(self.data_dir, fn))
    ...
    def data_dir(self):
        ...
        sfaira_path = os.path.join(self._data_path, self.directory_formatted_doi)
