...
class Dataset(DatasetBase):
    ...
    def __init__(
        ...
        self.species = "mouse"
        self.id = "mouse_peripheral_blood_2018_microwell-seq_han_003_10.1016/j.cell.2018.02.001"
    ...
    def _load(self, fn=None):
        if fn is None:
            ...
            fn = os.path.join(self.path, "mouse/temp_mouse_atlas/500more_dge/PeripheralBlood3_dge.txt.gz")
