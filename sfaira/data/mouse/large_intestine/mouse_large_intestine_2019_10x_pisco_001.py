...
class Dataset(DatasetBase):
    ...
    def __init__(
        ...
        self.species = "mouse"
        self.id = "mouse_large_intestine_2019_10x_pisco_001_10.1101/661728"
        self.source = source
        if self.source == "aws":
        ...
        self.organ = "large_intestine"
        self.sub_tissue = "large_intestine"
    ...
    def _load(self, fn=None):
        if fn is None:
            ...
            fn = os.path.join(self.path, "mouse/large_intestine/Large_Intestine_droplet.h5ad")
            if self.source == "aws":
                fn = os.path.join(self.path, "mouse/large_intestine/tabula-muris-senis-droplet-processed-official-annotations-Large_Intestine.h5ad")
            elif self.source == "figshare":
                fn = os.path.join(self.path, "mouse/large_intestine/Large_Intestine_droplet.h5ad")
            else:
                raise ValueError("source %s not recognized" % self.source)
