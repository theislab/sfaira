...
class Dataset(Dataset_d10_1101_661728):
    ...
    def __init__(
        ...
        self.id = "mouse_trachea_2019_smartseq2_pisco_001_10.1101/661728"
        self.organ = "trachea"
    ...
    def _load(self, fn=None):
        if fn is None:
            ...
            if self.source == "aws":
                fn = os.path.join(self.path, "mouse", "trachea", "tabula-muris-senis-facs-processed-official-annotations-Trachea.h5ad")
            elif self.source == "figshare":
                fn = os.path.join(self.path, "mouse", "trachea", "Trachea_facs.h5ad")
            else:
