    ...
    def __init__(
        ...
        self.class_maps = {
            "0": {
                ...
                'Endocrine cell(Pancreas)': ["pancreatic A cell", "pancreatic D cell", "pancreatic PP cell"],
                'Dividing cell(Pancreas)': ["pancreatic A cell", "pancreatic D cell", "pancreatic PP cell"],
