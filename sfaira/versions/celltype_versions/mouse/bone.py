...
class CelltypeVersionsMouseBone(CelltypeVersionsBase):

    def __init__(self, **kwargs):
        self.celltype_universe = {
            "0": CELLTYPES_MOUSE_BONE_V0
        }
        self.ontology = {
            "0": ONTOLOGIES_MOUSE_BONE_V0
        }
        super(CelltypeVersionsMouseBone, self).__init__(**kwargs)
