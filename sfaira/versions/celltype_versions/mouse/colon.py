...
ONTOLOGIES_MOUSE_COLON_V0 = {
    "names": {},
    "ontology_ids": {},
}


class CelltypeVersionsMouseColon(CelltypeVersionsBase):

    def __init__(self, **kwargs):
        self.celltype_universe = {
            "0": CELLTYPES_MOUSE_COLON_V0
        }
        self.ontology = {
            "0": ONTOLOGIES_MOUSE_COLON_V0
        }
        super(CelltypeVersionsMouseColon, self).__init__(**kwargs)
