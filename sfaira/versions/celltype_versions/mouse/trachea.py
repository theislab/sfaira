...
class CelltypeVersionsMouseTrachea(CelltypeVersionsBase):

    def __init__(self, **kwargs):
        self.celltype_universe = {
            "0": CELLTYPES_MOUSE_TRACHEA_V0
        }
        self.ontology = {
            "0": ONTOLOGIES_MOUSE_TRACHEA_V0
        }
        super(CelltypeVersionsMouseTrachea, self).__init__(**kwargs)
