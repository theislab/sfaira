...
CELLTYPES_HUMAN_LUNG_V0 = [
    ['1_Cycling cells', "nan"],
    ['1_Unicorns and artifacts', "nan"],
    ['2_Cartilage', "nan"],
    ['2_Fetal airway progenitors', "nan"],
    ['2_Mesothelium', "nan"],
    ['AT1', "nan"],
    ['AT2', "nan"],
    ['Acinar', "nan"],
...
ONTOLOGIES_HUMAN_LUNG_V0 = {
    "names": {
        ...
        "1_Stroma": ['2_Mesothelium', 'Fibroblasts', 'Myofibroblasts', 'Fibromyocyte', 'Airway smooth muscle',
                     'Venous smooth muscle', '2_Cartilage'],
